...
DROP TABLE SHIP_STOPS CASCADE CONSTRAINTS PURGE;
DROP TABLE IDLE_SHIP CASCADE CONSTRAINTS PURGE;
...
CREATE TABLE STOPS(
    ...
    TRIP_ID INTEGER,
    STOPS_ARRIVAL_DATE DATE,
    STOPS_DEPARTURE_DATE DATE,
    FOREIGN KEY (TRIP_ID) REFERENCES TRIP (TRIP_ID)
);

CREATE TABLE SHIP_STOPS(
    STOPS_NAME CHAR(25),
    MMSI NUMBER(9),
...
CREATE TABLE IDLE_SHIP(
    MMSI NUMBER(9) CONSTRAINT pk_MMSI_IDLE_SHIP PRIMARY KEY ,
    YEAR_SHIP INTEGER,
   IDLE_DAYS integer
);
--INSERTS
