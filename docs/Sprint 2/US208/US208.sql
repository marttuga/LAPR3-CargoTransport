...
CREATE OR REPLACE FUNCTION getOccupancyRate(v_MMSI SHIP.MMSI%TYPE, v_CARGO_MANIFEST_ID CARGO_MANIFEST.CARGO_MANIFEST_ID%TYPE)
RETURN NUMBER IS 
...
BEGIN
DBMS_OUTPUT.PUT_LINE(getOccupancyRate(303221000, 65432));
END;
