...
public class KdTreeTest {
    ...
    public void testFindMin() {
        ...
        assertEquals(obj1,tree.findMin());
    }
    ...
    public void getALL() {
        KdTree<Object> tree = new KdTree<>();
        tree.insert(obj3, 10, 10);
        List<Object> treeExpected = tree.getAll();
        assertEquals(1, treeExpected.size());
        tree.insert(obj2, 0, 5);
        treeExpected = tree.getAll();
        assertEquals(2, treeExpected.size());
        tree.insert(obj1, 0, 0);
        treeExpected = tree.getAll();
        assertEquals(3, treeExpected.size());
        tree.insert(obj5, 100, 100);
        treeExpected = tree.getAll();
        assertEquals(4, treeExpected.size());
        tree.insert(obj4, 50, 50);
        treeExpected = tree.getAll();
        assertEquals(5, treeExpected.size());
