...
class ChainedShipAtribComparatorTest {
    ...
    void compare() {
        ...
        al.add(ship1);
        al.add(ship2);
        Collections.sort(al, new ChainedShipAtribComparator(new ComparatorShipAtribByMMSI(), new ComparatorShipAtribDescByTraveledDistance()));
