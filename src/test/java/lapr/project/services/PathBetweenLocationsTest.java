...
class PathBetweenLocationsTest {
    ...
    void LandAndSeaPathStartInCityEndsCity() throws SQLException, IOException {
        ...
        assertFalse(Objects.requireNonNull(pathBetweenLocations.pathWithMandatoryLocations(BuildMatrixGraphController.getInstance().getLocationMap(), orig, dest, intermediaryPoints, Comparator.comparingDouble(Borders::getWeight), BinaryOperator.minBy(Comparator.comparingDouble(Borders::getWeight)), new Borders(), path)).contains(mandatory1));

        intermediaryPoints.add(mandatory1);
        assertTrue(Objects.requireNonNull(pathBetweenLocations.pathWithMandatoryLocations(BuildMatrixGraphController.getInstance().getLocationMap(), orig, dest, intermediaryPoints, Comparator.comparingDouble(Borders::getWeight), BinaryOperator.minBy(Comparator.comparingDouble(Borders::getWeight)), new Borders(), path)).contains(mandatory1));
    ...
    void MaritimePath() throws SQLException, IOException {
        ...
        assertFalse(Objects.requireNonNull(pathBetweenLocations.maritimePath(BuildMatrixGraphController.getInstance().getLocationMap(), orig, dest, intermediaryPoints, Comparator.comparingDouble(Borders::getWeight), BinaryOperator.minBy(Comparator.comparingDouble(Borders::getWeight)), new Borders(), path)).contains(mandatory1));

        intermediaryPoints.add(mandatory1);

        assertTrue(Objects.requireNonNull(pathBetweenLocations.maritimePath(BuildMatrixGraphController.getInstance().getLocationMap(), orig, dest, intermediaryPoints, Comparator.comparingDouble(Borders::getWeight), BinaryOperator.minBy(Comparator.comparingDouble(Borders::getWeight)), new Borders(), path)).contains(mandatory1));

        assertFalse(Objects.requireNonNull(pathBetweenLocations.maritimePath(BuildMatrixGraphController.getInstance().getLocationMap(), orig, dest, intermediaryPoints, Comparator.comparingDouble(Borders::getWeight), BinaryOperator.minBy(Comparator.comparingDouble(Borders::getWeight)), new Borders(), path)).contains(mandatory2));

        intermediaryPoints.add(mandatory2);

        assertTrue(Objects.requireNonNull(pathBetweenLocations.maritimePath(BuildMatrixGraphController.getInstance().getLocationMap(), orig, dest, intermediaryPoints, Comparator.comparingDouble(Borders::getWeight), BinaryOperator.minBy(Comparator.comparingDouble(Borders::getWeight)), new Borders(), path)).contains(mandatory2));

        assertFalse(Objects.requireNonNull(pathBetweenLocations.maritimePath(BuildMatrixGraphController.getInstance().getLocationMap(), orig, dest, intermediaryPoints, Comparator.comparingDouble(Borders::getWeight), BinaryOperator.minBy(Comparator.comparingDouble(Borders::getWeight)), new Borders(), path)).contains(mandatory3));

        intermediaryPoints.add(mandatory3);

        assertTrue(Objects.requireNonNull(pathBetweenLocations.maritimePath(BuildMatrixGraphController.getInstance().getLocationMap(), orig, dest, intermediaryPoints, Comparator.comparingDouble(Borders::getWeight), BinaryOperator.minBy(Comparator.comparingDouble(Borders::getWeight)), new Borders(), path)).contains(mandatory3));
    }
