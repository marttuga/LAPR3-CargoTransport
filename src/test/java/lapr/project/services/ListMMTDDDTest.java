...
class ListMMTDDDTest {
    ...
    ListMMTDDD listMMTDDD = new ListMMTDDD();
    @AfterEach
     void tearDown() {
    ...
    void allShips() {
        ...
        if (!ReadFilesController.isUseBigFiles()) {
            ...
            List<ShipAtrib> fg = new LinkedList<>(listMMTDDD.allShips(BuildTreeController.getInstance().getBSTByShipMMSI()));
    ...
    @Test
    void shipMmsiMovTDDD() throws ParseException {
        ...
        ShipMMSI shipMMSI4 = new ShipMMSI(ship4);
        ShipMMSI shipMMSI5 = new ShipMMSI(ship5);
        list.add(shipMMSI1);list.add(shipMMSI2);list.add(shipMMSI3);list.add(shipMMSI4);list.add(shipMMSI5);
        ShipAtrib s=new ShipAtrib(212180000, 4, 54.076, 54.033);

        assertEquals(s, listMMTDDD.shipMmsiMovTDDD(list));
    ...
    void sameMMSIList() throws ParseException {
        ...
        assertEquals(list, listMMTDDD.sameMMSIList(listt, 210950000));
    }
    ...
    void containShip()  {
        ...
        assertTrue(listMMTDDD.containShip(list, 210950000));
    }
    @Test
    void notContainShip()  {
        List<ShipAtrib> list = new LinkedList<>();
        ...
        assertFalse(listMMTDDD.containShip(list, 210950001));
    }
    ...
    void listDescTravDist()  {
        ...
        List<ShipAtrib> listSorted = listMMTDDD.listDescTravDist(list);
    ...
    void listAsceNumMov() {
        ...
        List<ShipAtrib> listSorted = listMMTDDD.listAsceNumMov(list);
