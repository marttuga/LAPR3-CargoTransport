...
class ClosestCitiesAndPortsTest {
    ClosestCitiesAndPorts closestCitiesAndPorts;

    @BeforeEach
    void setUp() {
        closestCitiesAndPorts = new ClosestCitiesAndPorts();
    }
    ...
    void getClosestPlaces() throws SQLException, IOException {
      ...
      //  System.out.println( map2.get("Europe").get(1).getName());
