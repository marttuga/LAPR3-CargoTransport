...
class CriticalPortsTest {

    CriticalPorts criticalPorts;

    @BeforeEach
    void setUp() {
        criticalPorts = new CriticalPorts();
    }
    ...
    void getPortsCriticality() throws SQLException, IOException {
        ...
        List<Location> expected1 = criticalPorts.getPortsCriticality(graph, 1, allLocations);
        ...
        List<Location> expected2 = criticalPorts.getPortsCriticality(graph, 2, allLocations);
